              ...
              <div>
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    placeholder="https://cdn1.xmlbankasi.com/p1/gurbuzoyuncak/image/data/xml/bayi.xml"
                    className="flex-1 px-3 py-2 rounded-lg border border-gray-200 dark:border-gray-700"
                  />
                  <button
                    onClick={() => setXmlSettings({ productImagesUrl: 'https://cdn1.xmlbankasi.com/p1/gurbuzoyuncak/image/data/xml/bayi.xml' })}
                  ...
                  <button
                    onClick={async () => {
                      try {
                        ...
                        if (result.success) {
                          alert('Resim linkleri başarıyla eklendi!');
                        } else {
                          alert(`Hata: ${result.error}`);
                        }
                      } catch (error) {
                        alert('Resim ekleme işlemi sırasında bir hata oluştu');
                      }
                    }}
